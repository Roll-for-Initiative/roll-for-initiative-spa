...
const IMAGES = ['dragon.jpg', 'dwarf.jpg', 'jelle.jpg', 'wizard.jpg']
...
export class PlayerCard {
  ...
  async loadModel() {
    const model = await BABYLON.SceneLoader.ImportMeshAsync(
      '',
      '/roll-for-initiative-spa/models/card.glb',
      '',
      this.scene
    )
    ...
    backdropMaterial.diffuseTexture = new BABYLON.Texture(
      '/roll-for-initiative-spa/models/textures/wood.jpg',
      this.scene
    )
    ...
    console.log(imgName)
    pictureMaterial.diffuseTexture = new BABYLON.Texture(
      `/roll-for-initiative-spa/models/textures/${imgName}`,
      this.scene
    )
